...
//change
$multiple_currency_price = get_post_meta( $post_id, 'wp_travel_multiple_currency_price', true );
$multiple_currency_price = ( $multiple_currency_price ) ? $multiple_currency_price : $price;
...
//change
$multiple_currency_price_attribute = 'disabled="disabled"';
$multiple_currency_price_style_class = 'hidden';

if( $multiple_currency_price ) {
    $multiple_currency_price_attribute = '';
    $multiple_currency_price_style_class = '';   
}
...
<table class="form-table pricing-tab">
    ...
    <?php //change ?>
    <tr class="multiple-currency-row <?php echo esc_attr(  )?>" 
